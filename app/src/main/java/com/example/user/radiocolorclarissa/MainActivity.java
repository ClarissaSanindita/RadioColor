package com.example.user.radiocolorclarissa;
...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rdb1 = (RadioButton) findViewById(R.id.rdb2);
        rdb1 = (RadioButton) findViewById(R.id.rdb3);
        rdb1 = (RadioButton) findViewById(R.id.rdb4);
        rdb1 = (RadioButton) findViewById(R.id.rdb5);
        rdb1 = (RadioButton) findViewById(R.id.rdb6);
        rdb1 = (RadioButton) findViewById(R.id.rdb7);
        rdb1 = (RadioButton) findViewById(R.id.rdb8);
